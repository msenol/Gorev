...
func (s *APIServer) dispatchMCPTool(handlers *mcp.Handlers, toolName string, params map[string]interface{}, wsCtx *WorkspaceContext) (interface{}, error) {
	...
	case "tools/list":
		...
		tools := []map[string]interface{}{
			...
			{"name": "gorev_duzenle", "description": "Edit task content", "inputSchema": map[string]interface{}{"type": "object", "properties": map[string]interface{}{"id": map[string]interface{}{"type": "string"}, "baslik": map[string]interface{}{"type": "string"}, "aciklama": map[string]interface{}{"type": "string"}}, "required": []string{"id"}}},
			...
			{"name": "gorev_hierarchy", "description": "Manage task hierarchy (unified: create_subtask|change_parent|show)", "inputSchema": map[string]interface{}{"type": "object", "properties": map[string]interface{}{"action": map[string]interface{}{"type": "string", "enum": []string{"create_subtask", "change_parent", "show"}}, "parent_id": map[string]interface{}{"type": "string"}, "baslik": map[string]interface{}{"type": "string"}}, "required": []string{"action"}}},
			...
			{"name": "gorev_intelligent_create", "description": "AI-powered task creation", "inputSchema": map[string]interface{}{"type": "object", "properties": map[string]interface{}{"baslik": map[string]interface{}{"type": "string", "description": "Task title"}, "aciklama": map[string]interface{}{"type": "string", "description": "Task description"}, "auto_split": map[string]interface{}{"type": "boolean", "description": "Auto-split into subtasks"}, "estimate_time": map[string]interface{}{"type": "boolean", "description": "Estimate task duration"}, "smart_priority": map[string]interface{}{"type": "boolean", "description": "AI-suggested priority"}, "suggest_template": map[string]interface{}{"type": "boolean", "description": "Suggest matching template"}, "proje_id": map[string]interface{}{"type": "string", "description": "Project ID"}}, "required": []string{"baslik"}}},
		}
		result = map[string]interface{}{
			"tools": tools,
		}
